 ...
 * memcached protocol.
 *
 * $Id: slabs.c 515 2007-04-17 00:59:12Z plindner $
 */
#include "memcached.h"
#include <sys/stat.h>
...
typedef struct _slabclass { /**DSU xfgen_ignore */
    unsigned int size;      /* sizes of items */
    unsigned int perslab;   /* how many items per slab */

    void ** E_OPAQUE slots;  /* list of item ptrs */ /**DSU xfgen */
    unsigned int sl_total;  /* size of previous array */
    unsigned int sl_curr;   /* first free slot */

    void * E_OPAQUE end_page_ptr;  /* pointer to next free item at end of page, or 0 */ /**DSU xfgen */
    unsigned int end_page_free; /* number of items remaining at end of last alloced page */

    unsigned int slabs;     /* how many slabs were allocated for this class */

    void ** E_OPAQUE slab_list;  /* array of slab pointers */ /**DSU xfgen */
